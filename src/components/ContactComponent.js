...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email)  {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            errors.firstname = "First Name should be greater than or equal to 2 characters";
        else if(this.state.touched.firstname && firstname.length > 10)
            errors.firstname = "First Name should be less than or equal to 10 characters";
        

        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = "Last Name should be greater than or equal to 2 characters";
        ...
        if(this.state.touched.telnum && !reg.test(telnum))
            ...
            errors.telnum = "Tel. Number should have exactly 10 digits";
